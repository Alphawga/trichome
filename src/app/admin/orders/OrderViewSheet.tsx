...
export function OrderViewSheet({ order, open, onOpenChange }: OrderViewSheetProps) {
          ...
          <div>
            ...
            <div className="space-y-2 bg-gray-50 p-4 rounded-lg">
              ...
              <div className="border-t pt-2 mt-2 flex justify-between">
                ...
                <span className="text-lg font-bold text-[#38761d]">₦{order.total.toLocaleString()}</span>
              </div>
            </div>
          </div>
