  ...
  return (
    <div>
      <div className="flex items-center mb-6">
        ...
        <span
          className={`ml-4 px-3 py-1 text-sm font-semibold rounded-full ${getStatusColor(mockOrder.status)}`}
        >
          {mockOrder.status}
        </span>
      </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white p-6 rounded-lg border">
            <h2 className="text-lg font-bold mb-4">
              Items in Order ({mockOrder.items.length})
            </h2>
            ...
            <div className="text-right mt-4 pr-2 border-t pt-4">
              ...
              <p className="text-gray-600">
                Shipping: <span className="font-medium text-black">₦4,500</span>
              </p>
              <p className="font-bold text-lg mt-2">
                Total:{" "}
                <span className="text-black">
                  ₦{(mockOrder.amount + 4500).toLocaleString()}
                </span>
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {mockOrder.orderDate} at 10:30 AM
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {mockOrder.orderDate} at 10:32 AM
                  </p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {mockOrder.orderDate} at 11:15 AM
                  </p>
                </div>
              </div>
            </div>
