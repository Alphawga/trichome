...
export function ProductDetailsClient() {
  ...
  const {
    ...
    isLoading,
    error,
  } = trpc.getProductBySlug.useQuery(
    { slug: String(slug) },
    { enabled: !!slug },
  );
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 pb-12 sm:pb-16 max-w-[2200px]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 max-w-6xl mx-auto mb-12 sm:mb-16">
            ...
            <div className="flex flex-col">
              <p className="text-[24px] sm:text-[28px] lg:text-[32px] font-bold mb-3 text-gray-900">
                {product?.name}
              </p>
              ...
              {/* Payment badge */}
              <div className="mt-4 flex items-center gap-2 text-[12px] sm:text-[13px] text-gray-600">
                <svg
                  className="w-4 h-4 shrink-0 text-[#40702A]"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <title>Secured by Paystack</title>
                  <path
                    fillRule="evenodd"
                    d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z"
                    clipRule="evenodd"
