  ...
  return (
    <div className="min-h-screen bg-trichomes-soft">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pb-12 sm:pb-16 max-w-7xl">
        <h1 className="text-[24px] sm:text-[32px] lg:text-[36px] font-heading font-semibold mb-6 sm:mb-8 text-trichomes-forest">
          Order history
        </h1>
            ...
            <div className="bg-white rounded-xl border border-trichomes-forest/10 overflow-x-auto shadow-sm">
              <table className="w-full text-left min-w-[700px]">
                <thead className="bg-trichomes-sage border-b border-trichomes-forest/10">
                  <tr>
                    <th className="p-3 sm:p-4 font-heading font-semibold text-[14px] sm:text-[15px] text-trichomes-forest">
                      Order Number
                    </th>
                    <th className="p-3 sm:p-4 font-heading font-semibold text-[14px] sm:text-[15px] text-trichomes-forest">
                      Items
                ...
                <tbody>
                  {orders.map((order) => (
                    <tr
                      key={order.id}
                      className="border-b border-trichomes-forest/10 last:border-b-0 hover:bg-trichomes-sage/30 transition-colors duration-150"
                    >
                      <td className="p-3 sm:p-4 font-mono text-[13px] sm:text-[14px] text-trichomes-forest font-body">
                        {order.order_number}
                      </td>
