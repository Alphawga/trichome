              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-4">
                {collections.map((category, index) => (
                  ...
                  >
                    ...
                    <div className=" mx-auto  h-[280px] md:h-[650px]  bg-white border border-trichomes-forest/10 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-200">
                      ...
                      <div className="relative w-full h-full">
                        ...
                        <div className="absolute inset-x-0 bottom-0 h-1/2 bg-linear-to-t from-black via-black/60 to-transparent pointer-events-none" />
                      </div>
