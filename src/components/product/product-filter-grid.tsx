      ...
      <div className="flex-1 min-w-0">
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {["a", "b", "c", "d", "e", "f", "g", "h"].map((key, _i) => (
              <div
                key={key}
                className="bg-white border border-[#1E3024]/10 p-4 animate-pulse shadow-sm"
              >
          ...
          <div className="text-center py-12 sm:py-16 bg-white rounded-[12px] border border-[#1E3024]/10 shadow-sm">
            <p className="text-[16px] text-red-600 font-body mb-2">
              Error loading products
            </p>
            <p className="text-[14px] text-[#1E3024]/60 font-body mb-4">
          ...
          /* Empty State */
          <div className="text-center py-12 sm:py-16 bg-white rounded-[12px] border border-[#1E3024]/10 shadow-sm">
            <p className="text-[16px] text-[#1E3024]/70 font-body mb-2">
              {emptyMessage}
            </p>
            <p className="text-[14px] text-[#1E3024]/60 font-body">
              {emptyDescription}
            </p>
          </div>
        ) : (
